  ...
  return (
    <SistentLayout title="Card" >
      <div className="content">
        ...
        <p>
        The Card component is a flexible and customizable UI element used to display content in a structured and visually appealing manner, this component is part of the Sistent library and provides additional features and customization options.
        </p>
